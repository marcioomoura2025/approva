...
- **Contagem regressiva** — o Painel pergunta uma vez se há concurso à vista; marcando a data, um card mostra quantos dias faltam junto do que há para fazer hoje (revisões pendentes). Aceita mais de um concurso, usa o dia local do usuário e muda de tom quando a data passa.
